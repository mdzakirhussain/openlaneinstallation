...
cd "/home/vvi"
su - "vvi" -c "git clone https://github.com/RTimothyEdwards/magic.git;"
cd "magic/"
./configure 
sudo make
sudo make install
...
cd "/home/vvi"
su - "vvi" -c "git clone https://github.com/YosysHQ/yosys.git;"
cd "yosys/"
sudo make
sudo make install
...
su - "vvi" -c "git clone https://github.com/The-OpenROAD-Project/OpenSTA.git;"
cd "OpenSTA/"
mkdir build
cd "build/"
